...
<div class="container center">
    ...
    @foreach($posts as $post)
        <article>
            ...
            <p class="post-by"><i class="fa fa-clock-o" aria-hidden="true"></i> {{ $post->created_at->setTimezone('America/Chicago')->diffForHumans() }} by <a class="user-posts" href="{{ URL::to('/user_posts' , $post->user_id) }}">{{ $post->user->firstname }} {{ $post->user->lastname }}</a></p>
